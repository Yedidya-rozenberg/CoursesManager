...
namespace CoursesManager.DAL
{
    ...
    //    List<Request> GetNewRequest();
    //    List<Request> GetRequestByParameter(string parameterName, string Parameter);
    //    bool UpdateRequestStatus(int requesrID, string newStatus);
    //}
